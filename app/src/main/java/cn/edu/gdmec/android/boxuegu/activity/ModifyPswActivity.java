...
public class ModifyPswActivity extends AppCompatActivity {
    ...
    private void init() {
        TextView tv_main_titile = (TextView) findViewById(R.id.tv_main_title);
        tv_main_titile.setText("修改密码");
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(originalPsw)){
                    ...
                    Toast.makeText(ModifyPswActivity.this,"输入密码和原始密码不一致",Toast.LENGTH_SHORT).show();
                    return;
                    ...
                    Toast.makeText(ModifyPswActivity.this,"请输入再次新密码",Toast.LENGTH_SHORT).show();
                    return;
